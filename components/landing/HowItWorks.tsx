    ...
    >
      <div className="flex w-12 flex-shrink-0 flex-col items-center">
        <motion.div
          ...
          className={`flex h-12 w-12 items-center justify-center rounded-full text-[13px] font-bold tracking-wide text-white transition-all duration-500 ${
            inView
              ? 'bg-gradient-to-br from-accent to-violet shadow-[0_0_24px_rgba(91,95,239,0.45)]'

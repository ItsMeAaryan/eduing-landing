      ...
      <div className="relative z-10 flex w-full max-w-[1280px] flex-wrap items-center gap-[60px]">
        ...
        >
          <motion.div
            ...
            className="flex w-full max-w-[720px] flex-col overflow-hidden rounded-3xl border border-white/[0.08] shadow-[0_30px_60px_rgba(0,0,0,0.55),inset_0_1px_0_rgba(255,255,255,0.1)] backdrop-blur-xl [transform:rotateY(-5deg)_rotateX(5deg)] [transform-style:preserve-3d] min-h-[480px]"
